...
function setupReveal() {
  const revealTargets = qsa(".service-card, .service-detail, .equipment-card, .store-group, .form-card, .value-card, .contact-card, .map-card, .order-sidecard, .proof-steps div, .proof-check, .process-strip, .instagram-callout, .work-feature, .meet-copy, .team-card");
